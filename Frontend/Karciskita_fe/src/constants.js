...
export const OurService = [
  {
    ...
    decription: 'Accommodating online purchases through the website, We support all the major payment method in Indonesia, from bank transfer to electronic money.',
    logo: FaCreditCard,
  },
  {
    id: 2,
    title: 'Admin System',
    decription: 'Create and monitor your event’s ticket sales reports, in real time anywhere and anytime',
    logo: RiDashboard2Fill,
  },
  {
    id: 3,
    title: 'Security',
    decription: 'We build our system with security in mind, so you as event organizer can focus on your event.',
    logo: RiLock2Fill,
  },
];
