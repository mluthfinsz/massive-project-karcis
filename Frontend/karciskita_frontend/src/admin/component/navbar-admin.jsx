  ...
  return (
    <div>
      <Navbar variant="dark" expand="lg" className="navbar-admin">
        <Navbar.Brand >
          <img src={logo} alt="" style={{ width: "30%" }} className="navbar-admin-img"/>
        </Navbar.Brand>
        <Navbar.Toggle aria-controls="basic-navbar-nav" className="ml-auto navbar-admin-toggle" />
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <Nav.Link as={NavLink} to={"/participant"}>
            <i className="bi bi-people-fill icon-sidebar"></i>Participant Manager
          </Nav.Link>
